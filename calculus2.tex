...
\newcommand\longdiv[2]{%
	...
	Two notes to remember is that L'Hopital rule  will come in handy in multiple situations. Also, not to get in misconception with another types of integral, this is only applied in the definite integrals. 
	...
	This was the normal, or easy type of questions you will be able to momentarily solve and notice. In the other one, suppose you are getting the integral of a function on $ [a,b] $ that has a vertical asymptote at $ b $ ( $ f $ is on $[a,b)$ ). 
