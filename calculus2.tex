...
\begin{figure}[h!]
\centering
\includegraphics[width=0.3\textwidth]{./sphereexamplesolid.png}
...
\]
	...
	\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{./Example of the washer technique in calculating volume bounded by curves x and x^2 around x-axis .png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{./shellvolumes.png}
